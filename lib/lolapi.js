(function() {
  ...
  exports.league = function(summoner_id, region, callback) {
    var url;
    url = "/api/" + region + "/v2.1/league/by-summoner/" + summoner_id;
    return query(url, null, callback);
  };

  exports.game = function(summoner_id, region, callback) {
    var url;
    url = "/api/lol/" + region + "/v1.1/game/by-summoner/" + summoner_id + "/recent";
    return query(url, null, callback);
  };

  exports.statsSummary = function(summoner_id, region, callback) {
    var url;
    url = "/api/lol/" + region + "/v1.1/stats/by-summoner/" + summoner_id + "/summary";
    return query(url, 'season=SEASON3', callback);
  };

  exports.statsRanked = function(summoner_id, region, callback) {
    var url;
    url = "/api/lol/" + region + "/v1.1/stats/by-summoner/" + summoner_id + "/ranked";
    return query(url, null, callback);
  };

  exports.summonerMasteries = function(summoner_id, region, callback) {
    var url;
    url = "/api/lol/" + region + "/v1.1/summoner/" + summoner_id + "/masteries";
    return query(url, null, callback);
  };

  exports.summonerRunes = function(summoner_id, region, callback) {
    var url;
    url = "/api/lol/" + region + "/v1.1/summoner/" + summoner_id + "/runes";
    return query(url, null, callback);
  };

  exports.summonerByName = function(summoner_name, region, callback) {
    var url;
    url = "/api/lol/" + region + "/v1.1/summoner/by-name/" + summoner_name;
    return query(url, null, callback);
  };

  exports.summonerByID = function(summoner_id, region, callback) {
    var url;
    url = "/api/lol/" + region + "/v1.1/summoner/" + summoner_id;
    return query(url, null, callback);
  };

  exports.summoners = function(summoners, region, callback) {
    var url;
    url = "/api/lol/" + region + "/v1.1/summoner/" + summoner_id + "/name";
    return query(url, null, callback);
  };

  exports.team = function(summoner_id, region, callback) {
    var url;
    url = "/api/" + region + "/v2.1/team/by-summoner/" + summoner_id;
    return query(url, null, callback);
  };
